...
$(".box").click(function(){
    ...
    if(isEmpty(this.id)){
        ...
        if(winningCondition()){
            ...
            if(turn%2===0){
                $("h1").html("Player 1 won <br>Tap To Restart The Game");
                winDrawAudio();
            }else{
                $("h1").html("Player 2 won <br>Tap To Restart The Game");
                winDrawAudio();
            }
            ...
            if(turn===10){
                $("h1").html("Match Draw <br>Tap To Restart The Game");
                winDrawAudio();
                resetGame=1;
                alreadyWinned=1;
            }
...
function winningCondition() {
    ...
    //console.log($("#box1").text().trim()+","+ $("#box2").text().trim()+","+$("#box3").text().trim());
